...
public:
	...
	virtual bool Init(ID3D11Device* device, HWND hwnd, unsigned int numLights) = 0;
...
protected:
	...
	bool InitShaderDataNoLayout(ID3D11Device* device, HWND hwnd, LPCWSTR vsFilename, LPCWSTR psFilename);
