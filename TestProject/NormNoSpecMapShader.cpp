...
void NormNoSpecMapShader::Shutdown()
{
	Shader::Shutdown();
...
bool NormNoSpecMapShader::PrepareShader(ID3D11DeviceContext* deviceContext)
{
...
bool NormNoSpecMapShader::SetConstantShaderParameters(void* data, ID3D11DeviceContext* deviceContext)
{
