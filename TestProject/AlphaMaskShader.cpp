...
bool AlphaMaskShader::PrepareShader(ID3D11DeviceContext* deviceContext)
{
...
bool AlphaMaskShader::SetConstantShaderParameters(void* data, ID3D11DeviceContext* deviceContext)
{
...
bool AlphaMaskShader::SetPerMeshParameters(void* data, ID3D11DeviceContext* deviceContext)
{
	D3D11_MAPPED_SUBRESOURCE mappedResource;
